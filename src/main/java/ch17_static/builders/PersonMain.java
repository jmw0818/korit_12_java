...
//        Person person = new Person();
        /*
            private Person(Builder builder)로 정의한 매개변수 생서자만 있으니 기본 생성자가 없다는 점에서 오류 발생.
...
//        Person person = new Person("김일", 20, "서울특별시 종로구");
        // 이상의 AllArgsConstructor를 Builder 패턴을 적용하여 객체 생성을 해보겠다.
        Person person1 = new Person.Builder().age(21).address("부산광역시 부산진구").name("김일").build();
        // 필드 순서를 다르게 넣어도 만들어 졌다.
