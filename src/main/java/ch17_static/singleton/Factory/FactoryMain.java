...
//        System.out.println(smartPhone1);
        // 공장을 통하지 않고 스마트폰 객체를 생성할 수 있다.
        // 이상의 이유 : @AllArgsConstructor을 적용했는데, 기본적으로 public이다.
        // 그래서 PACKAGE로 수정했다.
...
/*
    어떤 공장에서 메서드를 호출했는가 와는 상관없이
    createSerialNumber() 메서드를 호출한 결과가 단일한 Samsung 객체에서 비롯된다는 것을 알 수 있음. (싱글톤)
